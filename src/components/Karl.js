        ...
        <div className={classes.root}>
            ...
            <ul>
                ...
                <li>
                    ...
                    ergreift Partei für die Sache der Freiheit; ebenfalls wie
                    Franz begnadeter Rhetoriker
                </li>
                <li>
                ...
                <li>
                    ...
                    Sturm und Drang auf der einen und die Empfindsamkeit auf der
                    anderen → jugendliche heroische Tatkraft vs. Heimweh des
                    verlorenen Sohnes
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    [V,2]Die Hatz nach Franz enthält tief religiöse Komponente →
                    Gottesdienst mit Karl als Hohepriester in vollkommener
                    Selbstverblendung
                </li>
            </ul>
        </div>
