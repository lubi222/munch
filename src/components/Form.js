    ...
    return (
        <div className={classes.root}>
            ...
            <ul className={classes.ul}>
                ...
                <li>
                    Sein Gesprächsverhalten ist durch seine Absicht ... bestimmt
                </li>
            ...
            <ul className={classes.ul}>
                ...
                <li>
                    Aus dieser Außerung/Antwort lässt sich auf seine Einstellung
                    zu ... schließen
                </li>
                <li>
                    Die Beziehung der Gesprächspartner bleibt konstant/ändert
                    sich
                </li>
            </ul>
            <h4 className={classes.Title}>Gesprächsinhalt/Gesprächsverlauf</h4>
            <ul className={classes.ul}>
                ...
                <li>Der Gesprächsverlauf lässt sich folgendermaßen gliedern</li>
                <li>Der Dialog lässt eine Entwicklung erkennen, da</li>
                <li>
                    Das Resultat des Dialogs ist der Entschluss/die Erkenntnis
                </li>
                <li>Der Wendepunkt des Gesprächs ist</li>
            </ul>
            <h4 className={classes.Title}>Sprachlich-rhetorische Mittel</h4>
            <ul className={classes.ul}>
                <li>Der Satzbau ist vorwiegend hypotaktisch/parataktisch</li>
                <li>
            ...
            <ul className={classes.ul}>
                <li>
                    Für das weitere Geschehen ist der Dialog insofern wichtig,
                    als
                </li>
                <li>
