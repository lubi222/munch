        ...
        <div className={classes.root}>
            ...
            <div style={{ marginLeft: "1rem" }}>
                ...
                <ul>
                    ...
                    <li>
                        Beschützt Karl als Spiegelberg versucht zu die Räuber
                        gegen ihn aufzuhetzen, und ersticht ihn mit einem Dolch:
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        zurückkommen oder gar keinen.“ (S.124, Z.34 ff.), „Er
                        ist maustot – mich sieht er nicht wieder (Schießt sich
                        vor die Stirn.)“ (S.136,Z.36 ff.)
                    </li>
                </ul>
                <h4>Schwarz</h4>
                <ul>
