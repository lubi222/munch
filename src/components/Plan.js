        ...
        <div className={classes.root}>
            ...
            <ul className={classes.ul}>
                ...
                <li>
                    ...
                    <ul>
                        <li>TATTE-Satz</li>
                        <li>
                            Wichtigste Aspekte benennen, die später analysiert
                            werden
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            ...
                            Bühnenhandlung, Inhalt des Gesprächs, Positionen,
                            Argumente)
                        </li>
                        <li>Gesprächssituation (z.B. Ort, Zeit, Atmosphäre)</li>
                        <li>
                            Figuren (z.B. Motive, persönliche Situation,
                            Weltanschauung, Verhaltensweisen, Eigenschaften)
                        </li>
                        <li>
                            Figurenkonstellation (z.B. Beziehungen zueinander,
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            Sprecherwechsel; symmetrisch/komplementär; Formen
                            sprachlichen Handelns, z.B. fragen, vorwerfen,
                            bitten, informieren, argumentativ
                        </li>
                        <li>
                        ...
                        <li>
                            Adressatenbezug (z.B. Adressaten in und außerhalb
                            der Szene, Art der Ansprache)
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Sprachduktus (z.B. Pausen, Unterbrechungen, Ausrufe,
                            Wiederholungen)
                        </li>
                        <li>
            ...
            <ul className={classes.ul}>
                ...
                <li>
                    ...
                    (z.B. Epoche, Gattung, Motivgeschichte, Dramentheorie,
                    Biografie des Autors, historischer/ politisch-sozialer/
